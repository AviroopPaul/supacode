...
const DSAProblemPanel = () => {
  ...
  return (
    <div className="w-1/2 h-screen overflow-y-auto bg-[#18002b] p-4">
      <div className="flex flex-col items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {topics.map((topic) => (
                ...
                >
                  ...
                  <h3 className="text-gray-300 text-lg font-semibold ml-2">
                    {topic.name}
                  </h3>
                </div>
              ))}
            ...
            <div className="space-y-2">
              {problems.map((problem) => (
                ...
                >
                  ...
                  <span
                    className={`px-2 py-1 rounded text-sm text-gray-300 ${getDifficultyColor(
                      problem.difficulty
                    )}`}
                  >
                    {problem.difficulty}
        ...
        {selectedProblem && (
          <div className="text-gray-300 w-full">
            ...
            <div className="mb-4">
              <span
                className={`px-2 py-1 rounded text-sm mr-2 ${getDifficultyColor(
